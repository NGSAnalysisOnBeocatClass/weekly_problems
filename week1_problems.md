...
The goal of this week's problem is to use what you've learned about understanding usage statements, reading manuals/help menus, identifying NGS file extensions and writing commands to run programs that may be new to you. Make use of the help menus, the Github FAQ pages and the class google+ group while you work. 
...
#####FOR WEEKLY PROBLEMS YOU SHOULD DOWNLOAD THE THE WEEKLY PROBLEM TEXT FILE FROM KSOL (IN THIS CASE "week1_problems.txt"). RECORD ALL COMMANDS THAT YOU RUN IN THAT TEXT FILE USING TEXTWRANGLER OR NOTEPAD++ AS THE EDITOR. SAVE YOUR TEXT FILE AND UPLOAD IT TO KSOL WHEN YOU HAVE COMPLETED THE ASSIGNMENT. YOU WILL BE GRADED ON THIS PLAIN TEXT FILE AND THE OUTPUT OF YOUR COMMANDS (IN THE `~/hw1` DIRECTORY YOU WILL CREATE). YOU WILL KNOW WHEN YOU HAVE A COMMAND TO WRITE AND RUN WHEN YOU SEE AN INSTRUCTION IN RED TEXT LIKE THE ONE BELOW:
